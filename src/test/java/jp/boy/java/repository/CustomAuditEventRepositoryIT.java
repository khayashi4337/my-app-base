package jp.boy.java.repository;

import jp.boy.java.MyAppBaseApp;

import jp.boy.java.config.Constants;
import jp.boy.java.config.audit.AuditEventConverter;
import jp.boy.java.domain.PersistentAuditEvent;
...
import static jp.boy.java.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
