...
@RestController
@RequestMapping("/api/my-app-base-kafka")
public class MyAppBaseKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MyAppBaseKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MyAppBaseKafkaResource(KafkaProperties kafkaProperties) {
